...
class ActorAuthorizer implements Authorizer
{
	...
	protected function isUserOfRole(Actor $entity, $user)
	{
		if ($entity->role) {
			return in_array($user->role, $entity->role);
		}

		// If no roles are selected, the Actor is considered completely public.
		return true;
	}
	...
	public function isAllowed(Entity $entity, $privilege)
	{
		...
		// Finally, we check if the Actor is only visible to specific roles.
