...
class Ushahidi_Validator_Source_Update extends Validator
{
	protected $repo;
	protected $role_repo;

	protected $default_error_source = 'source';

	public function __construct(UpdateSourceRepository $repo, RoleRepository $role_repo)
	{
		$this->repo = $repo;
	...
	protected function getRules()
	{
		return [
			...
			'parent_id' => [
				[[$this->repo, 'doesSourceExist'], [':value']],
			],
			'slug' => [
				['min_length', [':value', 2]],
				['alpha_dash'],
