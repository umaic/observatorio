...
class Ushahidi_Validator_Actor_Update extends Validator
{
	protected $repo;
	protected $role_repo;

	protected $default_error_source = 'actor';

	public function __construct(UpdateActorRepository $repo, RoleRepository $role_repo)
	{
		$this->repo = $repo;
	...
	protected function getRules()
	{
		return [
			...
			'parent_id' => [
				[[$this->repo, 'doesActorExist'], [':value']],
			],
			'slug' => [
				['min_length', [':value', 2]],
				['alpha_dash'],
